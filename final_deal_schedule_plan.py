...
class DealSchedulePlan:
    ...
    def _scheduled_purchase_row(deal):
        ...
        return {
            ...
            # item 1: graph = THIS deal's own capacity (total) vs what's used here.
                    ...
                    rows.append(
                        {
                            ...
                            # item 1: total = THIS purchase deal's own capacity; used = what
                            # this tag drew from it (leftover stays available for others).
